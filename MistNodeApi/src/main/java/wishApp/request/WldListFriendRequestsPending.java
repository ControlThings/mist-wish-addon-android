 ...
 */
class WldListFriendRequestsPending {
    static void request(Wld.ListFriendRequestsPendingCb callback) {
        final String op = "wld.listFriendRequestsPending";
        ...
        RequestInterface.getInstance().wishRequest(op, buffer.toByteArray(), new RequestInterface.Callback() {
            private Wld.ListFriendRequestsPendingCb callback;
            ...
            private RequestInterface.Callback init(Wld.ListFriendRequestsPendingCb callback) {
