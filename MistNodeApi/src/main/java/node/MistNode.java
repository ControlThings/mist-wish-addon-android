...
public class MistNode {
    ...
    public synchronized native int wishRequestCancel(int id);
     ...
     * to be read, when satisfying a control.follow request perhaps after the Endpoint's value has been declared to have changed via node.MistNode.changed().
     *
