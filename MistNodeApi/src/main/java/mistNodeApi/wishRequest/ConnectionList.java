...
import mistNodeApi.wishRequest.Connection;
        ...
        RequestInterface.getInstance().wishRequest(op, buffer.toByteArray(), new RequestInterface.Callback() {
            ...
            private void response(byte[] dataBson) {
                try {
                    ...
                    ArrayList<mistNodeApi.Connection> connections = new ArrayList<mistNodeApi.Connection>();
                    BsonArray bsonArray = bson.get("data").asArray();
                    for (BsonValue bsonValue : bsonArray) {
                        mistNodeApi.Connection connection = new mistNodeApi.Connection();
